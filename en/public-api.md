...
API response may show the fields not specified by the guide. These fields are internally used by TOAST, and not used because they are subject to change without prior notice.
